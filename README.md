...
```javascript
incrmae = require( 'https://cdn.jsdelivr.net/gh/stdlib-js/stats-incr-mae@v0.1.0-umd/browser.js' )
```
...
```html
<script type="text/javascript" src="https://cdn.jsdelivr.net/gh/stdlib-js/stats-incr-mae@v0.1.0-umd/browser.js"></script>
```
...
[test-image]: https://github.com/stdlib-js/stats-incr-mae/actions/workflows/test.yml/badge.svg?branch=v0.1.0
[test-url]: https://github.com/stdlib-js/stats-incr-mae/actions/workflows/test.yml?query=branch:v0.1.0
